...
import { Heart, Gift, Home, BookOpen, ShoppingBag, Phone, Mail, MapPin } from 'lucide-react';
  ...
  const categories = [
    {
      ...
      description: "Your gently used appliances can help families in need create a comfortable home environment."
    },
    {
      id: 2,
      ...
      description: "Support education by donating learning tools and resources to students who need them most."
    },
    {
      id: 3,
      ...
      description: "Help others stay warm and confident with your clothing donations."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-center px-4">
          ...
          >
            ...
            <p className="text-xl text-white/90 max-w-2xl mx-auto mb-8">
              Transform lives by donating your gently used items to those in need
            </p>
            <motion.button
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        <h2 className="text-3xl font-bold text-center mb-12">What Can You Donate?</h2>
