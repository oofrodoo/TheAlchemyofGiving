  ...
  return (
    <div className="min-h-screen bg-lime-100">
      ...
      <div className="w-full max-w-md bg-white p-8 rounded-xl shadow-lg overflow-hidden relative 
          ...
          <p className="text-center text-gray-600 mb-6">Create an account to start donating and making a difference.</p>
            ...
            <div className="flex items-start mt-2">
              ...
              <div className="ml-3 text-sm">
                <label htmlFor="terms" className="text-gray-600">
                  I agree to the <a href="#" className="text-green-600 hover:text-green-700 hover:underline">Terms of Service</a> and <a href="#" className="text-green-600 hover:text-green-700 hover:underline">Privacy Policy</a>
                </label>
              </div>
            </div>
          ...
          <p className="text-center text-gray-600 text-sm mt-6">
            Already have an account? <Link to="/login" className="text-green-600 hover:text-green-700 hover:underline font-medium transition">Log in</Link>
          </p>
        </div>
      </div>
    </div>
